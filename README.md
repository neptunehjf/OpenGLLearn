...
-   ‌**025Instancing** - インスタンシングによる大量オブジェクト描画の最適化（10万インスタンス/130fps）
...
-   ‌**035DeferredShading** - ディファードシェーディングによるGPU負荷軽減（GPU負荷レベル2時：59fps→105fps）
-   ‌**036SSAO** - ディファードシェーディングとSSAOアルゴリズムによるスクリーン空間アンビエントオクルージョンの実装
